...
const Employees = () => {
    ...
    const fetchEmployees = async () => {
        try {
            ...
            const res = await axios.get("https://icyflame-ltd-core.onrender.com/api/v1/team");
    ...
    const handleSave = async () => {
        ...
        try {
            if (isEditMode) {
                ...
                const res = await axios.put(`https://icyflame-ltd-core.onrender.com/api/v1/team/${editingEmployeeId}`, employeeData);
                console.log("Update success:", res.data);
                toast.success("Employee updated successfully");
            } else {
                console.log("Creating new employee:", employeeData);
                const res = await axios.post("https://icyflame-ltd-core.onrender.com/api/v1/team", employeeData);
    ...
    const handleDelete = async (id) => {
        ...
        try {
            ...
            const res = await axios.delete(`https://icyflame-ltd-core.onrender.com/api/v1/team/${id}`);
